        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxDocumentPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    SignatureCircularPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    TradeRegistryPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailVerificationExpireDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    IsVipActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ...
                    AgencyApplicationId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customers_AgencyApplications_AgencyApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_AgencyApplicationId",
                table: "Customers",
                column: "AgencyApplicationId",
                unique: true,
                filter: "[AgencyApplicationId] IS NOT NULL");
